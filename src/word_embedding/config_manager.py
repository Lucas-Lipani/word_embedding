...
class ConfigManager:
    ...
    def find_or_create_config_dir(
            ...
            if config_file.exists():
                try:
                    ...
                    if saved_sig == target_sig:
                        ...
                        print(f"[CONFIG] Reutilizando pasta existente: {config_dir.name}")
        ...
        print(f"[CONFIG] Criando nova pasta de configuração: {new_config_dir.name}")
    ...
    def save_config(
        ...
        if config_file.exists():
            print(f"[CONFIG] config.json já existe em {config_dir.name}, pulando...")
            return config_file
